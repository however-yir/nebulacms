...
@GVK(group = "auth.nebulacms.io", version = "v1alpha1", kind = "AuthProvider",
    singular = "authprovider", plural = "authproviders")
public class AuthProvider extends AbstractExtension {

    public static final String AUTH_BINDING_LABEL = "auth.nebulacms.io/auth-binding";

    public static final String PRIVILEGED_LABEL = "auth.nebulacms.io/privileged";
