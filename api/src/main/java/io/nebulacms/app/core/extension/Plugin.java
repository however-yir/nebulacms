...
@GVK(group = "plugin.nebulacms.io", version = "v1alpha1", kind = "Plugin", plural = "plugins",
    singular = "plugin")
@EqualsAndHashCode(callSuper = true)
public class Plugin extends AbstractExtension {

    public static final String SYSTEM_RESERVED_LABEL_KEY = "plugin.nebulacms.io/system-reserved";

    public static final String BUILT_IN_KEEPER_FINALIZER = "plugin.nebulacms.io/built-in-keeper";
