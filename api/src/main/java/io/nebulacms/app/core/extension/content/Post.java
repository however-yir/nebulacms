 ...
 *
 * @author guqing
 * @see <a href="https://github.com/nebula-labs/nebulacms/issues/2322">issue#2322</a>
 * @since 2.0.0
 */
@Data
...
public class Post extends AbstractExtension {
    ...
    public static final String STATS_ANNO = "content.nebulacms.io/stats";
     ...
     */
    public static final String SCHEDULING_PUBLISH_LABEL = "content.nebulacms.io/scheduling-publish";

    public static final String DELETED_LABEL = "content.nebulacms.io/deleted";
    public static final String PUBLISHED_LABEL = "content.nebulacms.io/published";
    public static final String OWNER_LABEL = "content.nebulacms.io/owner";
    public static final String VISIBLE_LABEL = "content.nebulacms.io/visible";

    public static final String ARCHIVE_YEAR_LABEL = "content.nebulacms.io/archive-year";

    public static final String ARCHIVE_MONTH_LABEL = "content.nebulacms.io/archive-month";
    public static final String ARCHIVE_DAY_LABEL = "content.nebulacms.io/archive-day";
