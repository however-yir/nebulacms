...
public class Snapshot extends AbstractExtension {
    ...
    public static final String KEEP_RAW_ANNO = "content.nebulacms.io/keep-raw";
    public static final String PATCHED_CONTENT_ANNO = "content.nebulacms.io/patched-content";
    public static final String PATCHED_RAW_ANNO = "content.nebulacms.io/patched-raw";
