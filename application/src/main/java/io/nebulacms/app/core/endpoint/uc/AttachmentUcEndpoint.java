...
public class AttachmentUcEndpoint implements CustomEndpoint {
    ...
    public static final String POST_NAME_LABEL = "content.nebulacms.io/post-name";
    public static final String SINGLE_PAGE_NAME_LABEL = "content.nebulacms.io/single-page-name";
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("uc.api.storage.nebulacms.io/v1alpha1");
    }
