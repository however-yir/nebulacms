...
public class UcPostEndpoint implements CustomEndpoint {
    ...
    private static final String CONTENT_JSON_ANNO = "content.nebulacms.io/content-json";
                ...
                () -> route()
                    ...
                    .PUT("/{name}/draft", this::updateMyPostDraft, builder -> builder.tag(tag)
                        ...
                        .description("""
                            ...
                            "content.nebulacms.io/content-json" into annotations and refer to 
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("uc.api.content.nebulacms.io/v1alpha1");
    }
