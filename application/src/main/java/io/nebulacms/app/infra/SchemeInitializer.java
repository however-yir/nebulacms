...
import io.nebulacms.app.core.extension.attachment.PolicyTemplate;
import io.nebulacms.app.core.extension.content.Category;
import io.nebulacms.app.core.extension.content.Category.CategorySpec;
import io.nebulacms.app.core.extension.content.Comment;
import io.nebulacms.app.core.extension.content.Comment.CommentSpec;
import io.nebulacms.app.core.extension.content.Comment.CommentStatus;
import io.nebulacms.app.core.extension.content.Post;
import io.nebulacms.app.core.extension.content.Post.PostSpec;
import io.nebulacms.app.core.extension.content.Post.PostStatus;
import io.nebulacms.app.core.extension.content.Post.VisibleEnum;
import io.nebulacms.app.core.extension.content.Reply;
import io.nebulacms.app.core.extension.content.Reply.ReplySpec;
import io.nebulacms.app.core.extension.content.SinglePage;
import io.nebulacms.app.core.extension.content.SinglePage.SinglePageSpec;
import io.nebulacms.app.core.extension.content.Snapshot;
import io.nebulacms.app.core.extension.content.Tag;
import io.nebulacms.app.core.extension.content.Tag.TagSpec;
import io.nebulacms.app.core.extension.content.Tag.TagStatus;
import io.nebulacms.app.core.extension.notification.Notification;
import io.nebulacms.app.core.extension.notification.Notification.NotificationSpec;
...
import io.nebulacms.app.core.extension.notification.Subscription.InterestReason;
...
import io.nebulacms.app.extension.index.IndexSpec;
    ...
    public void start() {
        ...
        schemeManager.register(Thumbnail.class, indexSpec -> {
            indexSpec.add(new IndexSpec()
                // see io.nebulacms.app.core.attachment.ThumbnailMigration
                // .setUnique(true)
        ...
        // migration.nebulacms.io
        schemeManager.register(Backup.class);

        // notification.nebulacms.io
