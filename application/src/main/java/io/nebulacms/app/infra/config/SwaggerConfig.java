...
public class SwaggerConfig {
    ...
    GroupedOpenApi publicV1alpha1Api() {
        return GroupedOpenApi.builder()
            ...
            .pathsToExclude(
                ...
                "/apis/api.notification.nebulacms.io/v1alpha1/userspaces/**",
                "/apis/api.notification.nebulacms.io/v1alpha1/notifiers/**"
            )
            .build();
    }
    ...
    GroupedOpenApi consoleV1alpha1Api() {
        return GroupedOpenApi.builder()
            ...
            .pathsToMatch(
                ...
                "/apis/api.console.nebulacms.io/v1alpha1/**"
            )
            .build();
    }
    ...
    GroupedOpenApi extensionV1alpha1Api() {
        return GroupedOpenApi.builder()
            ...
            .pathsToMatch(
                "/api/v1alpha1/**",
                "/apis/content.nebulacms.io/v1alpha1/**",
                "/apis/theme.nebulacms.io/v1alpha1/**",
                "/apis/security.nebulacms.io/v1alpha1/**",
                "/apis/migration.nebulacms.io/v1alpha1/**",
                "/apis/auth.nebulacms.io/v1alpha1/**",
                "/apis/metrics.nebulacms.io/v1alpha1/**",
                "/apis/storage.nebulacms.io/v1alpha1/**",
                "/apis/plugin.nebulacms.io/v1alpha1/**",
                "/apis/notification.nebulacms.io/**",
                "/apis/migration.nebulacms.io/**"
            )
            .build();
    }
