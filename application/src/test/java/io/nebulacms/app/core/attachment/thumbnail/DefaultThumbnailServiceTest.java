...
class DefaultThumbnailServiceTest {
    ...
    void shouldGetThumbnailDirectlyIfPermalinkIsInSite() throws MalformedURLException {
        when(externalUrlSupplier.getRaw()).thenReturn(URI.create("https://www.nebulacms.io").toURL());
        thumbnailService.get(URI.create("https://www.nebulacms.io/images/fake.png"), ThumbnailSize.M)
            .as(StepVerifier::create)
            .expectNext(URI.create("https://www.nebulacms.io/images/fake.png?width=800"))
            .verifyComplete();
    }
    ...
    void shouldGetEmptyThumbnailIfNoAttachmentsFound() throws MalformedURLException {
        ...
        thumbnailService.get(URI.create("https://fake.nebulacms.io/fake.png"))
            .as(StepVerifier::create)
            .expectNext(Map.of())
            .verifyComplete();
    ...
    void shouldGetThumbnailsIfAttachmentsFound() throws MalformedURLException {
        ...
        Mockito.when(
            ...
            .thenReturn(Flux.just(
                createAttachment("fake-png", "https://fake.nebulacms.io/fake.png",
