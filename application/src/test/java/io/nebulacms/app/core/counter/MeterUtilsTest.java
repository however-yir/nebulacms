...
class MeterUtilsTest {
    ...
    void nameOf() {
        ...
        assertThat(s).isEqualTo("posts.content.nebulacms.io/fake-post");
    }

    @Test
    void testNameOf() {
        String s = MeterUtils.nameOf("content.nebulacms.io", "posts", "fake-post");
        assertThat(s).isEqualTo("posts.content.nebulacms.io/fake-post");
    }
    ...
    void visitCounter() {
        ...
        MeterUtils.visitCounter(meterRegistry, "posts.content.nebulacms.io/fake-post")
            .increment();
        RequiredSearch requiredSearch = meterRegistry.get("posts.content.nebulacms.io/fake-post");
    ...
    void upvoteCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        MeterUtils.upvoteCounter(meterRegistry, "posts.content.nebulacms.io/fake-post")
            .increment(2);
        RequiredSearch requiredSearch = meterRegistry.get("posts.content.nebulacms.io/fake-post");
    ...
    void totalCommentCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        MeterUtils.totalCommentCounter(meterRegistry, "content.nebulacms.io.posts.fake-post")
            .increment(3);
        RequiredSearch requiredSearch = meterRegistry.get("content.nebulacms.io.posts.fake-post");
    ...
    void isDownvoteCounter() {
        ...
        Counter downvoteCounter =
            MeterUtils.downvoteCounter(meterRegistry, "posts.content.nebulacms.io/fake-post");
    ...
    void isTotalCommentCounter() {
        ...
        Counter totalCommentCounter =
            MeterUtils.totalCommentCounter(meterRegistry, "posts.content.nebulacms.io/fake-post");
