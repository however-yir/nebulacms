...
class AbstractExtensionTest {
    ...
    void groupVersionKind() {
        ...
        extension.setApiVersion("fake.nebulacms.io/v1alpha1");
        extension.setKind("Fake");
        var gvk = extension.groupVersionKind();

        assertEquals(new GroupVersionKind("fake.nebulacms.io", "v1alpha1", "Fake"), gvk);
    }
    ...
    void testGroupVersionKind() {
        ...
        extension.groupVersionKind(new GroupVersionKind("fake.nebulacms.io", "v1alpha1", "Fake"));

        assertEquals("fake.nebulacms.io/v1alpha1", extension.getApiVersion());
