...
class JsonExtensionConverterTest {
    ...
    void convertTo() throws IOException {
        ...
        assertEquals("/registry/fake.nebulacms.io/fakes/fake", extensionStore.getName());
    ...
    void convertFrom() throws JsonProcessingException {
        ...
        store.setName("/registry/fake.nebulacms.io/fakes/fake");
    ...
    FakeExtension createFakeExtension(String name, Long version) {
        var fake = new FakeExtension();
        fake.groupVersionKind(new GroupVersionKind("fake.nebulacms.io", "v1alpha1", "Fake"));
        Metadata metadata = new Metadata();
