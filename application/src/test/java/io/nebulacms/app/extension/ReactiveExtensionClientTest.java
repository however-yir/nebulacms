...
class ReactiveExtensionClientTest {
    ...
    FakeExtension createFakeExtension(String name, Long version) {
        ...
        fake.setApiVersion("fake.nebulacms.io/v1alpha1");
        fake.setKind("Fake");
    ...
    Unstructured createUnstructured() throws JsonProcessingException {
        String extensionJson = """
            {
                "apiVersion": "fake.nebulacms.io/v1alpha1",
                "kind": "Fake",
                "metadata": {
                    "labels": {
                        "category": "fake",
    ...
    void shouldFetchAnExtension() {
        var storeName = "/registry/fake.nebulacms.io/fakes/fake";
    ...
    void shouldCreateSuccessfully() {
        ...
        when(converter.convertTo(any())).thenReturn(
            createExtensionStore("/registry/fake.nebulacms.io/fakes/fake"));
        when(storeClient.create(any(), any())).thenReturn(
            Mono.just(createExtensionStore("/registry/fake.nebulacms.io/fakes/fake")));
        ...
        verify(storeClient, times(1)).create(eq("/registry/fake.nebulacms.io/fakes/fake"), any());
    ...
    void shouldUpdateSuccessfully() {
        ...
        verify(storeClient)
            .update(eq("/registry/fake.nebulacms.io/fakes/fake"), eq(2L), any());
    }
    ...
    void shouldUpdateUnstructuredSuccessfully() throws JsonProcessingException {
        var fake = createUnstructured();
        var name = "/registry/fake.nebulacms.io/fakes/fake";
        ...
        verify(storeClient)
            .update(eq("/registry/fake.nebulacms.io/fakes/fake"), eq(12345L), any());
    }
