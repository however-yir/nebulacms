...
class DefaultExternalLinkProcessorTest {
    ...
    void process() throws MalformedURLException {
        ...
        assertThat(externalLinkProcessor.processLink("/test")).isEqualTo("https://nebulacms.io/test");
        ...
        when(externalUrlSupplier.getRaw()).thenReturn(URI.create("https://nebulacms.io/").toURL());
        assertThat(externalLinkProcessor.processLink("/test")).isEqualTo("https://nebulacms.io/test");
        assertThat(externalLinkProcessor.processLink("https://nebulacms.io/test"))
            .isEqualTo("https://nebulacms.io/test");
    }
    ...
    void processUriWithoutServerWebExchange(String link, String expectedLink)
        ...
        lenient().when(externalUrlSupplier.getRaw())
            .thenReturn(new URL("https://www.nebulacms.io/context-path"));
    ...
    static Stream<Arguments> processUriTestWithoutServerWebExchangeArguments() {
        return Stream.of(
            ...
            Arguments.of("/halo", "https://www.nebulacms.io/context-path/halo"),
            Arguments.of("halo", "https://www.nebulacms.io/context-path/halo"),
            Arguments.of("/halo?query", "https://www.nebulacms.io/context-path/halo?query"),
            Arguments.of(
                "/halo?query#fragment", "https://www.nebulacms.io/context-path/halo?query#fragment"
            ),
            Arguments.of("/halo/subpath", "https://www.nebulacms.io/context-path/halo/subpath"),
            Arguments.of("/halo/中文", "https://www.nebulacms.io/context-path/halo/%E4%B8%AD%E6%96%87"),
            Arguments.of("/halo/ooo%2Fooo", "https://www.nebulacms.io/context-path/halo/ooo%2Fooo")
        );
    }
    ...
    void processUriWithServerWebExchange(String link, String expectLink)
        throws MalformedURLException {
        lenient().when(externalUrlSupplier.getRaw())
            .thenReturn(URI.create("https://www.nebulacms.io").toURL());
        ...
        lenient().when(externalUrlSupplier.getURL(request)).thenReturn(
            new URL("https://antoher.nebulacms.io/context-path"));
        externalLinkProcessor.processLink(URI.create(link))
    ...
    static Stream<Arguments> processUriTestWithServerWebExchangeArguments() {
        return Stream.of(
            ...
            Arguments.of("/halo", "https://antoher.nebulacms.io/context-path/halo"),
            Arguments.of("halo", "https://antoher.nebulacms.io/context-path/halo"),
            Arguments.of("/halo?query", "https://antoher.nebulacms.io/context-path/halo?query"),
            Arguments.of("/halo?query#fragment",
                "https://antoher.nebulacms.io/context-path/halo?query#fragment"),
            Arguments.of("/halo/subpath", "https://antoher.nebulacms.io/context-path/halo/subpath"),
            Arguments.of("/halo/中文",
                "https://antoher.nebulacms.io/context-path/halo/%E4%B8%AD%E6%96%87"),
            Arguments.of("/halo/ooo%2Fooo", "https://antoher.nebulacms.io/context-path/halo/ooo%2Fooo")
        );
    }
