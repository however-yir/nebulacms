...
class RecipientResolverImplTest {
    ...
    void testExpressionMatch() {
        ...
        reason.getSpec().getSubject().setApiVersion("content.nebulacms.io/v1alpha1");
    ...
    void subjectMatchTest() {
        ...
        subject.setApiVersion("content.nebulacms.io/v1alpha1");
    ...
    private static Subscription createSubscription(Subscription.Subscriber subscriber) {
        ...
        interestReason.getSubject().setApiVersion("content.nebulacms.io/v1alpha1");
