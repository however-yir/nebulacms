package io.nebulacms.app.security.authentication.pat;
...
class PatTest {
    ...
    void generatePat() {
        ...
        webClient.post()
            .uri("/apis/uc.api.security.nebulacms.io/v1alpha1/personalaccesstokens")
            ...
            .value(pat -> {
                ...
                assertTrue(annotations.containsKey("security.nebulacms.io/access-token"));
            });
    }
