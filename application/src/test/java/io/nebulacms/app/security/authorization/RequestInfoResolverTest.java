...
public class RequestInfoResolverTest {
    ...
    void shouldResolveAsWatchRequestWhenRequestIsWebSocket() {
        var request = method(HttpMethod.GET, "/apis/fake.nebulacms.io/v1alpha1/fakes")
        ...
        List<CustomSuccessCase> testCases =
            List.of(
                ...
                new CustomSuccessCase("POST",
                    "/apis/api.plugin.nebulacms.io/v1/plugins/other/posts/foo",
                    "create", "apis",
                    "api.plugin.nebulacms.io", "v1", "", "plugins", "posts", "other", "foo",
                    new String[] {"plugins", "other", "posts", "foo"}),

                // api version identification
                new CustomSuccessCase("POST",
                    "/apis/api.plugin.nebulacms.io/v1beta3/plugins/other/posts/bar", "create",
                    "apis", "api.plugin.nebulacms.io", "v1beta3", "", "plugins", "posts", "other",
                    "bar",
        ...
        List<ErrorCases> postCases =
            List.of(new ErrorCases("api resource has name and no subresource but post",
                ...
                new ErrorCases("apis resource has name and no subresource but post",
                    "/apis/api.nebulacms.io/v1alpha1/themes/install"));
