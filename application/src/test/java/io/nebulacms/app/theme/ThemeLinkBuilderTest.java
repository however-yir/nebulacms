...
class ThemeLinkBuilderTest {
    ...
    void linkInSite() throws URISyntaxException {
        ...
        assertThat(ThemeLinkBuilder.linkInSite(uri, "http://nebulacms.io/hello/world")).isFalse();
        // scheme is different and authority is different
        assertThat(ThemeLinkBuilder.linkInSite(uri, "https://nebulacms.io/hello/world")).isFalse();
