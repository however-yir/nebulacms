...
import type { ListedSinglePage } from "@nebula-labs/api-client";
import {
...
const commentSubjectRefKey = `content.nebulacms.io/SinglePage/${props.singlePage.page.metadata.name}`;
