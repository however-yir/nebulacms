...
import type { Backup } from "@nebula-labs/api-client";
...
import {
  ...
  VStatusDot,
  type StatusDotState,
} from "@nebula-labs/components";
import { utils, type OperationItem } from "@nebula-labs/ui-shared";
...
function handleDownload() {
  window.open(
    `/apis/console.api.migration.nebulacms.io/v1alpha1/backups/${props.backup.metadata.name}/files/${props.backup.status?.filename}`,
    "_blank"
  );
}
