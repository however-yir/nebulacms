...
import { consoleApiClient } from "@nebula-labs/api-client";
import { Dialog, Toast } from "@nebula-labs/components";
...
const endpoint = computed(() => {
  if (pluginToUpgrade.value) {
    return `/apis/api.console.nebulacms.io/v1alpha1/plugins/${pluginToUpgrade.value.metadata.name}/upgrade`;
  }
  return "/apis/api.console.nebulacms.io/v1alpha1/plugins/install";
});
