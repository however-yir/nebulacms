...
export const PersonalAccessTokenV1alpha1UcApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deletePat: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/apis/uc.api.security.nebulacms.io/v1alpha1/personalaccesstokens/{name}`
        ...
        generatePat: async (personalAccessToken: PersonalAccessToken, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/apis/uc.api.security.nebulacms.io/v1alpha1/personalaccesstokens`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        restorePat: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/apis/uc.api.security.nebulacms.io/v1alpha1/personalaccesstokens/{name}/actions/restoration`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        revokePat: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/apis/uc.api.security.nebulacms.io/v1alpha1/personalaccesstokens/{name}/actions/revocation`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
