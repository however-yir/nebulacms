...
import type { AnyExtension } from "@nebula-labs/richtext-editor";
...
export interface ExtensionPoint {
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/attachment-selector-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/editor-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/plugin-self-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/default-editor-extension-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/comment-subject-ref-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/backup-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/plugin-installation-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/post-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/single-page-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/comment-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/reply-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/plugin-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/backup-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/attachment-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/plugin-list-item-field-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/post-list-item-field-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/single-page-list-item-field-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/theme-list-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/theme-list-item-operation-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/user-detail-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/uc-user-profile-tabs-create
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/dashboard-widgets#consoledashboardwidgets
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui/dashboard-widgets#consoledashboardwidgetsinternalquick-actionitem
   */
 ...
 *
 * @see https://docs.nebulacms.io/developer-guide/plugin/basics/ui/entry
 */
export interface PluginModule {
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/api-reference/ui/route
   */
   ...
   * @see https://docs.nebulacms.io/developer-guide/plugin/extension-points/ui
   */
