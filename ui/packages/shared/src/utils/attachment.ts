import type { GetThumbnailByUriSizeEnum } from "@nebula-labs/api-client";
...
export class AttachmentUtils {
   ...
   * // Returns: "/apis/api.storage.nebulacms.io/v1alpha1/thumbnails/-/via-uri?uri=https%3A%2F%2Fexternal.com%2Fimage.jpg&width=1200"
   * ```
   */
  getThumbnailUrl(url: string, size: GetThumbnailByUriSizeEnum) {
    ...
    return `/apis/api.storage.nebulacms.io/v1alpha1/thumbnails/-/via-uri?uri=${encodeURIComponent(
      url
    )}&width=${width}`;
  }
