import type { Role } from "@nebula-labs/api-client";
import { coreApiClient } from "@nebula-labs/api-client";
import { Toast } from "@nebula-labs/components";
...
export function useRoleTemplateSelection(
   ...
   *         "labels": {
   *           "nebulacms.io/role-template": "true"
   *         },
   *         "annotations": {
   *           "rbac.authorization.nebulacms.io/dependencies": "[ \"role-template-view-users\", \"role-template-change-password\" ]\n",
   *           "rbac.authorization.nebulacms.io/module": "Users Management",
   *           "rbac.authorization.nebulacms.io/display-name": "User manage",
   *           "rbac.authorization.nebulacms.io/ui-permissions": "[\"system:users:manage\"]\n",
   *           "rbac.authorization.nebulacms.io/dependency-rules": "[{\"apiGroups\":[\"\"],\"resources\":[\"users\"],\"resourceNames\":[],\"nonResourceURLs\":[],\"verbs\":[\"get\",\"list\"]},{\"apiGroups\":[\"api.nebulacms.io\"],\"resources\":[\"users/password\"],\"resourceNames\":[],\"nonResourceURLs\":[],\"verbs\":[\"update\"]}]",
   *           "rbac.authorization.nebulacms.io/ui-permissions-aggregated": "[\"system:users:view\"]"
   *         },
   *         "version": 9
   *       }
   *     },
   ...
   *         "annotations": {
   *           "rbac.authorization.nebulacms.io/module": "Users Management",
   *           "rbac.authorization.nebulacms.io/display-name": "User View",
   *           "rbac.authorization.nebulacms.io/ui-permissions": "[\"system:users:view\"]\n",
   *           "rbac.authorization.nebulacms.io/dependency-rules": "[]",
   *           "rbac.authorization.nebulacms.io/ui-permissions-aggregated": "[]"
   *         },
   *         "version": 9
   *       }
   *     }
