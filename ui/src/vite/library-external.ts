...
export const setupLibraryExternal = (mode: string) => {
  ...
  const staticTargets: Target[] = [
    ...
    {
      src: "./node_modules/@nebula-labs/components/dist/index.iife.js",
      dest: "components",
      rename: `components.[hash].js`,
    },
    {
      src: "./node_modules/@nebula-labs/api-client/dist/index.iife.js",
      dest: "api-client",
      rename: `api-client.[hash].js`,
    },
    {
      src: "./node_modules/@nebula-labs/ui-shared/dist/index.iife.js",
      dest: "ui-shared",
      rename: `ui-shared.[hash].js`,
    },
    // TODO: Remove this in the future, only for compatibility.
    {
      src: "./node_modules/@nebula-labs/console-shared/index.js",
      dest: "console-shared",
      rename: `console-shared.[hash].js`,
    },
    {
      src: "./node_modules/@nebula-labs/richtext-editor/dist/index.iife.js",
      dest: "editor",
